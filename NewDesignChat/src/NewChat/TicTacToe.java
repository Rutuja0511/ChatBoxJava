...
//For player X//
	...
	private void initialize() {
		...
		btn1.setFont(new Font("Bodoni MT Black", Font.BOLD, 74));
		...
		btn2.setFont(new Font("Bodoni MT Black", Font.BOLD, 74));
		...
		btn3.setFont(new Font("Bodoni MT Black", Font.BOLD, 74));
		...
		lblNewLabel.setFont(new Font("Perpetua Titling MT", Font.BOLD, 20));
		...
		xCount.setFont(new Font("Tahoma", Font.BOLD, 37));
		xCount.setText("0");
		...
		btn4.setFont(new Font("Bodoni MT Black", Font.BOLD, 74));
		...
		btn5.setFont(new Font("Bodoni MT Black", Font.BOLD, 74));
		...
		btn6.setFont(new Font("Bodoni MT Black", Font.BOLD, 74));
		...
		lblNewLabel_1.setFont(new Font("Perpetua Titling MT", Font.BOLD, 20));
		...
		oCount.setFont(new Font("Tahoma", Font.BOLD, 37));
		oCount.setHorizontalAlignment(SwingConstants.CENTER);
		oCount.setText("0");
		panel_9.add(oCount, BorderLayout.CENTER);
		...
		btn7.setFont(new Font("Bodoni MT Black", Font.BOLD, 74));
		...
		btn8.setFont(new Font("Bodoni MT Black", Font.BOLD, 74));
		...
		btn9.setFont(new Font("Bodoni MT Black", Font.BOLD, 74));
		...
		btnReset.setFont(new Font("MS UI Gothic", Font.BOLD, 20));
		...
		btnExit.setFont(new Font("MS UI Gothic", Font.BOLD, 20));
