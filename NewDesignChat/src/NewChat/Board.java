...
public class Board extends JPanel implements ActionListener{
    ...
    public void loadImages(){
        ImageIcon i1 = new ImageIcon(Board.class.getResource("/NewChat/apple.png"));
        apple  = i1.getImage();
        
        ImageIcon i2 = new ImageIcon(Board.class.getResource("/NewChat/dot.png"));
        dot = i2.getImage();
        
        ImageIcon i3 = new ImageIcon(Board.class.getResource("/NewChat/head.png"));
        head = i3.getImage();
    }
